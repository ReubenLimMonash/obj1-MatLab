% Date: 15/11/2022
% Store the CDF of SINR vs height distance for U2U comm.
...
Pi_dBm = 20; Pi = 10^(Pi_dBm/10)/1000; %23dBm = 0.1995W Tx power
...
%         sinr_th = c(1:num_bin);
        % Store the simulated CDF of SINR
...
%%
% Save the variable
save("CDF_vs_Height_Dist_31UAV_Pi20dBm_member_UAV.mat",'dL_H','di','Pt','Pi','height','Num_member_UAV',...
    'CDF_sim','CDF_ln','CDF_beta','CDF_points',...
    'K_L_dB_store','sigma_N_L_dB_store','N');
