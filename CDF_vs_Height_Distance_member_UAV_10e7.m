...
%         G_i = antenna_gain(0,0,Go); % Antenna gain between leader and member i
        ...
        c = load("CDF_vs_Height_Dist_10e8/CDF_vs_Height_Dist_7UAV_member_UAV.mat","CDF_points").CDF_points(k,j,:); % Make sure to edit the file name for each no. of UAVs
...
%%
% Save the variable
save("CDF_vs_Height_Dist_7UAV_member_UAV_10e7.mat",'dL_H','di','Pt','Pi','height','Num_member_UAV',...
