...
Num_member_UAV = 1; %Number of member UAVs
...
%         reliability_sim(j,k) = 1 - interp1(c,CDF_sinr_sim,sinr_th); % This uses linear interpolation, with no extrapolation 
...
%%
% Save the variable
Note = "Antenna gains for U2G set to 1. R = 12.167kbps. 15 member UAV";
save("Reliability_vs_Height_Dist_Pi10dBm_R12167_15UAV.mat",'dL_H','di','Pt','Pi','height','theta_GCS',...
