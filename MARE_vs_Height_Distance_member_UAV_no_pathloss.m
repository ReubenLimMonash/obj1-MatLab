...
di = ones(1,Num_member_UAV-1)*di; % [5, 5] % Interfering UAVs distances
noise_dB = -107;
...
%         h = histogram(SINR_sim,150,'BinLimits',[0,mean_sinr+5*sigma_sinr],'Normalization','cdf');
...
%%
% Save the variable
save("MAEMRE_vs_Height_Dist_3UAV_member_UAV_no_pathloss.mat",'dL_H','di','Pt','Pi','height','Num_member_UAV',...
