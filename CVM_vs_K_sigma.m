%Date: 5/11/2021
%Calculating Cramer-von Mises criterion for CDF approximations of SINR
%w.r.t. K and sigma in 2D plot
...
save("CVM_vs_K_sigma.mat",'CVM_ln','CVM_beta','CVM_gh','K_L_dB','sigma_N_L_dB',...
    'dL_H','di','Pt','Pi','height','freq','noise','n');
%%
%Save results to file (for mean of abs error)
save("MAE_vs_K_sigma.mat",'MAE_ln','MAE_beta','MAE_gh','K_L_dB','sigma_N_L_dB',...
    'dL_H','di','Pt','Pi','height','freq','noise','n');
%%
%Save results to file (for mean of relative error)
save("MRE_vs_K_sigma.mat",'MRE_ln','MRE_beta','MRE_gh','K_L_dB','sigma_N_L_dB',...
    'dL_H','di','Pt','Pi','height','freq','noise','n');
%%
