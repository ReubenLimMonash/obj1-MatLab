...
pdf_sim = h.Values(1:150); %PDF values
...
% Plot normal CDF
figure();
plot(c,CDF_sinr_sim,'k','LineWidth',2);
hold on;
plot(c_points,CDF_sinr_ln,'ro','LineWidth',1.2,"MarkerSize",9);
hold on;
plot(c_points,CDF_sinr_beta,'sb','LineWidth',1.2,"MarkerSize",8);
hold on;
...
ylabel("CDF")
%title(sprintf("K = %d dB",K_L_dB));
legend("Simulated","Lognormal","\beta'","L-GH",'FontSize',14);
